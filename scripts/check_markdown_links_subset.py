#!/usr/bin/env python3
"""Validate local markdown links for an explicit list of markdown files."""
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Validate local markdown links for selected files"
    )
    ...
    print(f"OK: checked {checked} markdown files with no broken local links.")
    return 0
