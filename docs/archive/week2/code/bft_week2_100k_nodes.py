...
if __name__ == "__main__":
    ...
    print(f"  {'Byzantine %':<15} {'Sampled Time':<15} {'Hierarchical':<15} {'Speedup':<12}")
    print(f"  {'-'*60}")
    ...
    for bft in bft_levels:
        ...
        print(f"  {bft:3d}%{'':<11} {samp_time:7.2f}s{'':<8} {hier_time:7.2f}s{'':<8} {speedup:5.1f}x")
    
    # Accuracy Analysis
    print(f"\n  Accuracy Analysis (100K nodes):\n")
    print(f"  {'Byzantine %':<15} {'Sampled Acc':<15} {'Hierarchical':<15} {'Difference':<12}")
    print(f"  {'-'*60}")
    ...
    for bft in bft_levels:
        ...
        print(f"  {bft:3d}%{'':<11} {samp_acc:6.1f}%{'':<9} {hier_acc:6.1f}%{'':<9} {diff:5.1f}%")
